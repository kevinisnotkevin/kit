...
**Docker Container** - это запущенный и готовый к использованию экземпляр образа. Безопасность и стабильность процесса в контейнере обеспечивается изоляцией от остальной системы.
