...
- [cheat.sh - БД с примерами команд](http://cheat.sh)
- [explainshell - сервис, который автоматически разбирает сложную команду и обьясняет значение ее составных частей](https://explainshell.com/)
- [BASH Reference Manual](https://www.gnu.org/software/bash/manual/bash.html)

- [Тестирование на проникновение notion](https://sadykov.notion.site/cf24a07c98ee40b1a3907149babb0ca6)
- [Компьютерная экспертиза notion](https://ilitvin.notion.site/95eb43d81dac4f33848cedd6dc2f331b)
- [Методичка linux notion](https://ilitvin.notion.site/Linux-practice-91b020ac692b45028c05268e3a92762b)
...
- Что такое ollama?
- HTTP3?
- Какие есть средства сбора метрик? victoria metrics, prometheus...
- Что такое webauthn?
- Что такое KVM? Как работают VPN сервисы?
- Настроить взаимодействие между микросервисами. Если реализовывать в Docker, то какое решение лучше? Как еще можно реализовать? k8s?
- Что такое сокет?
- pydantic_settings что за модуль python?
