...
- [**ssh, scp**](materials/linux/ssh.md): Набор утилит, обеспечивающий защищённые соединения и передачу данных между двумя удалёнными компьютерами
